...
namespace Kyber::Renderer::RHI {
    ...
    Instance::Instance(const std::shared_ptr<Core::Window>& window)
        : m_Window(window)
    {
    ...
    void Instance::CreateInstance()
    {
        ...
        std::string name = m_Window->GetTitle();
...
#ifndef NDEBUG
        VK_CHECK(vkCreateDebugUtilsMessengerEXT(s_Instance, &messengerInfo, nullptr, &s_DebugMessenger));
#endif
    }
